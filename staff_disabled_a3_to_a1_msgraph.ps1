...
$logFile = "D:\CRON\Office365\LOG\A3_TO_A1\LicenseChangeLog_$logDate.txt"
...
$disabledUsersWithA3 = Get-MgBetaUser -Filter "accountEnabled eq false AND jobtitle eq 'Staff'" -All | Where-Object { $_.AssignedLicenses.SkuId -eq $a3LicenseSkuId }
...
foreach ($user in $disabledUsersWithA3) {
    ...
    try {
      ...
      # Define the user ID and the SKU IDs for the licenses
        ...
        $addLicenseSkuId = "78e66a63-337a-4a9a-8959-41c6654dfb56"  # License to add
        $removeLicenseSkuId = "4b590615-0888-425a-a965-b3bf7789848d"  # License to remove
        ...
        $logMessage = "Removed A3 and added A1Plus for user: $userUPN"
